...
const Reset = () => {
    ...
    return (
        <div className='md:py-16 pb-5 md:flex justify-center '>
            <div className=' md:block'>
                <img className='md:h-[55vh]' src='https://img.freepik.com/free-vector/forgot-password-concept-illustration_114360-4652.jpg?size=626&ext=jpg&uid=R123874945&ga=GA1.1.241201418.1699171553&semt=ais' alt='' /><hr />
            </div>

            <div className='px-3 md:px-5 py-2 text-center'>
                ...
                <div className='mt-4 text-center'>
                    <Link to='/login' className='text-white px-12 bg-black md:px-26 py-3' type='button'>Reset Password</Link>
                </div>
            </div>
        </div>
    )
